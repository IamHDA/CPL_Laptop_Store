        ...
        <form onSubmit={handleSubmit} className="flex flex-1 flex-col overflow-hidden">
          <div className="flex-1 overflow-y-auto px-6 py-5 space-y-4">
            <div>
              ...
              <input name="name" value={form.name} onChange={handle} placeholder="Laptop ASUS ROG Strix G16 / VGA RTX 4060..." className={inputCls(errors.name)} />
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                ...
                <input name="cpu" value={form.cpu} onChange={handle} placeholder="Intel Core i7-13700H" className={inputCls(false)} />
              </div>
              <div>
                <label className="mb-1.5 block text-[12px] font-medium text-[#1d1d1f]">Bộ nhớ RAM</label>
                <input name="ram" value={form.ram} onChange={handle} placeholder="16GB DDR5" className={inputCls(false)} />
              </div>
              <div>
                <label className="mb-1.5 block text-[12px] font-medium text-[#1d1d1f]">Card đồ họa (VGA)</label>
                <input name="vga" value={form.vga} onChange={handle} placeholder="NVIDIA RTX 4060 8GB" className={inputCls(false)} />
              </div>
              <div>
                <label className="mb-1.5 block text-[12px] font-medium text-[#1d1d1f]">Ổ cứng (Storage)</label>
                <input name="storage" value={form.storage} onChange={handle} placeholder="512GB SSD NVMe" className={inputCls(false)} />
              </div>
              <div>
                <label className="mb-1.5 block text-[12px] font-medium text-[#1d1d1f]">Màn hình (Screen)</label>
                <input name="screen" value={form.screen} onChange={handle} placeholder="15.6 inch FHD 144Hz" className={inputCls(false)} />
              </div>
            </div>
