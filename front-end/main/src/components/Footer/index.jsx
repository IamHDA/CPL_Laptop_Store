      ...
      <div className="max-w-[1200px] mx-auto px-6">
        <div className="grid grid-cols-1 gap-8 mb-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              <span className="text-white font-bold text-lg tracking-wide">CPL LAPTOP</span>
            </div>
            <p className="text-white/60 mb-5 leading-relaxed" style={{ fontSize: "12px" }}>
              CPL Laptop Store là hệ thống chuyên cung cấp laptop và linh kiện máy tính chính hãng — laptop gaming, laptop văn phòng, VGA, CPU, RAM, SSD — với đầy đủ giấy tờ bảo hành và giá cả cạnh tranh cho người dùng Việt Nam.
            </p>
        ...
        <div className="border-t border-white/10 pt-4 flex flex-col md:flex-row items-center justify-between gap-3">
          <p className="text-white/40" style={{ fontSize: "11px" }}>
            © 2026 CPL Laptop Store. Tất cả quyền lợi được bảo lưu.
          </p>
