          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <div className="text-center leading-tight">
                <span style={{ fontSize: "9px" }} className="block text-white/80 font-medium">Laptop &amp; Linh Kiện</span>
                <span style={{ fontSize: "9px" }} className="text-white/80">Chính Hãng</span>
              </div>
            </div>
            <p className="text-white/60 mb-5 leading-relaxed" style={{ fontSize: "12px" }}>
              HK Tech là hệ thống bán lẻ laptop và linh kiện máy tính chính hãng: laptop gaming,
              laptop văn phòng, workstation đồ họa, VGA, CPU, RAM &amp; SSD, màn hình và phụ kiện.
              Bảo hành theo tiêu chuẩn hãng, hỗ trợ trả góp 0%.
            </p>
